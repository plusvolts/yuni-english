...
(() => {
  ...
  function defaults() {
    return {
      settings: { parentPin: '1234', robotName: '로보', childName: 'Yuni', age: 'seven', hyunRel: 'brother', dailyLimit: 20, voice: 'native', koVoice: '', koRate: 0.9, goalStars: 50, goalText: '아빠와 약속한 선물' },
